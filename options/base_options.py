...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--step', type=str, default='5')
        self.parser.add_argument('--scale_param', type=float, default=0.1)
        self.parser.add_argument('--face', action='store_true', default=True)
        self.parser.add_argument('--fashiondir', type=str, default='data')

        # input/output sizes
        self.parser.add_argument('--image_nc', type=int, default=3)
        self.parser.add_argument('--pose_nc', type=int, default=18)
        self.parser.add_argument('--batchSize', type=int, default=1, help='input batch size')
        self.parser.add_argument('--old_size', type=int, default=(256, 256), help='Scale images to this size. The final image will be cropped to --crop_size.')
        ...
        self.parser.add_argument('--use_CS', action='store_true', default=False, help='#train with multi gpu')
        self.parser.add_argument('--use_skc', action='store_true', default=False, help='#train with multi gpu')
        self.parser.add_argument('--distributed', action='store_true', default=False, help='#train with multi gpu')

        # for setting inputs
        self.parser.add_argument('--dataset_mode', type=str, default='fashion')
        self.parser.add_argument('--dataroot', type=str, default='PATH/DataSet/Fashion')
    ...
    def parse(self, save=True):
        ...
        data_option_set = data.get_option_setter(opt.dataset_mode,opt.model)
